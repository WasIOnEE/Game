...
QT_MOC_LITERAL(1, 7, 3), // "Hit"
QT_MOC_LITERAL(2, 11, 0), // ""
QT_MOC_LITERAL(3, 12, 14), // "QGraphicsItem*"
QT_MOC_LITERAL(4, 27, 4), // "item"
QT_MOC_LITERAL(5, 32, 15) // "slotTimerBullet"

    },
    "Bullet\0Hit\0\0QGraphicsItem*\0item\0"
    "slotTimerBullet"
};
...
void Bullet::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Hit((*reinterpret_cast< QGraphicsItem*(*)>(_a[1])),(*reinterpret_cast< QGraphicsItem*(*)>(_a[2]))); break;
        ...
        {
            using _t = void (Bullet::*)(QGraphicsItem * , QGraphicsItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Bullet::Hit)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Bullet::Hit(QGraphicsItem * _t1, QGraphicsItem * _t2)
{
